...
Вывод результатов
Напишите функцию DisplayResults(letters, digits, spaces, punctuation int), которая принимает 
результаты анализа и выводит их на экран в удобочитаемом формате. Например:
